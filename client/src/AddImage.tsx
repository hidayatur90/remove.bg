...
const AddImage: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      setUploadedFile({ filePath: imagePath });
    } catch (error) {
    ...
    <>
      <div className="mx-auto max-w-270">
                ...
                <div className="col-span-5 xl:col-span-2">
                  <div className="rounded-sm border border-stroke bg-white">
                    <div className="border-b border-stroke py-4 px-7">
                      <h3 className="font-medium text-black">Upload Image</h3>
                    </div>
                    <div className="p-7">
                      <div className="mb-4 flex justify-center items-center">
                        <div className="h-40 w-32 rounded-md bg-gray-100 py-3">
                          <img
                            className="object-cover h-36 w-32"
                            src={
                              uploadedFile?.filePath
                                ? `http://localhost:3001${uploadedFile.filePath}`
                                : noUser
                            }
                            alt="User"
                          />
                      ...
                      <div
                        id="FileUpload"
                        className="relative mb-5.5 block w-full cursor-pointer hover:bg-gray-100 appearance-none rounded border border-dashed border-primary bg-gray py-4 px-4 sm:py-7.5"
                      >
                        <input
                          type="file"
                          accept="image/*"
                        ...
                        <div className="flex flex-col items-center justify-center space-y-3">
                          ...
                          <p className="mt-1.5">JPG, JPEG, PNG or GIF</p>
                          <p>(max size: 1MB)</p>
                        </div>
                      </div>
                    </div>
        ...
        <div className="text-sm flex justify-center mt-2">
          <p className="italic">&#169;puc-indonesia</p>
        </div>
      </div>
    </>
  );
